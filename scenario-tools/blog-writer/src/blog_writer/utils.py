"""Utility functions for blog_writer.

Defensive text/JSON extraction adapted from proven patterns.
...
def extract_text_from_response(response: str | object) -> str:
    """Extract plain text from AmplifierSession response.
...
def extract_json_from_response(response: str | object) -> dict[str, Any] | list[Any]:
    ...
    """
    # Step 1: Convert to text string using extract_text_from_response
